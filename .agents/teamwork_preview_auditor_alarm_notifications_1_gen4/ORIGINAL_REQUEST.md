...
Your role: Forensic Auditor (Gen 4) for the Native Alarm Integration milestone.
Your working directory: /Users/almanimation/Downloads/Caixa Remedios/medicaixa_app/.agents/teamwork_preview_auditor_alarm_notifications_1_gen4/
Your mission:
...
- Check that the unmounted context check-gates, AVAudioSession options category, timezone-aware DST calculations, and try-catch loops are implemented authentically with genuine logic.
